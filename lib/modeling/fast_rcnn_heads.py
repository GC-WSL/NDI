...
from model.pcl.pcl import get_proposal_clusters, _get_highest_score_proposals, _get_MIST_proposals
import nn as mynn
...
def get_fast_rcnn_targets(boxes, refine_score, im_labels):
    ...
    proposals = _get_MIST_proposals(boxes.copy(), cls_prob.copy(), im_labels.copy())
